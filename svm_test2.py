...
#
# def remove_class_data(test_data):
#     test_data_with_unknown_sent = []
#     for tag, features in test_data:
#         test_data_with_unknown_sent.append((0, features))
#     return test_data_with_unknown_sent
# neg_count = 0
# pos_count = 0
...
#     print(len(training))
#     print(len(test_fold))
#     model = svmlight.learn(svm_train, type='classification', verbosity=0)
#
#     svm_test = prepare_data_for_svm(test_fold, features_mapping)
#     svm_test_with_unknown_class = remove_class_data(svm_test)
